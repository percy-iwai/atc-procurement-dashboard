...
""")
    ...
    # FY別調達母数（予算書PDFより算出）
    # 算出方法: 空港整備勘定 歳出合計 − 人件費 − 維持費×非調達率 − 整備費0
    # FY2022-2024確定: 人件費(896/919/864)・維持費(1831/1812/1896)・整備費(1169/1211/1199)を
    #   CONFIRMED_PROC_BASE(2137/2147/2407)から逆算し、維持費非調達率47-64%を確認
    # FY2013-2019推計: 維持費が大きく(1937-2276)借入金償還が多いため非調達率55%を適用
    # FY2025推計: 人件費888・維持費1914・整備費1101→非調達率43%適用
    _PROC_BASE_OKU = {
        2013: 1250, 2014: 1560, 2015: 1620, 2016: 1910,
        2017: 2020, 2018: 2450, 2019: 2440,
        2020: 2152, 2021: 2146, 2022: 2137, 2023: 2147, 2024: 2407,
        2025: 2190,
    }
    _PROC_BASE_CONFIRMED = {2022, 2023, 2024}  # PDFから詳細内訳を確認済み
